...
if len(q) > 200:
    print("large")
    label = Label(master, text=q.strip(), wraplength = wrapLen, font=("ariel",12), bg='#000011', fg = '#FFFFFF')
else:
...
if server_status:
    ...
    if len(skills_list) >= 1:
        checkbutton = Checkbutton(master, text=skills_list[0], variable=var1, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='yellow',selectcolor="black", command=lambda: toggle_var(var1))
        checkbutton.grid(row=3, column = 2, sticky=W)
    if len(skills_list) >=2:
        checkbutton2 = Checkbutton(master, text=skills_list[1], variable=var2, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='yellow',selectcolor="black", command=lambda: toggle_var(var2))
        checkbutton2.grid(row=4, column = 2, sticky=W)
        
    if len(skills_list) >= 3:
        checkbutton3 = Checkbutton(master, text=skills_list[2], variable=var3, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='white',selectcolor="black", command=lambda: toggle_var(var3))
        checkbutton3.grid(row=5, column = 2,sticky=W)
        
    if len(skills_list) >= 4:
        checkbutton4 = Checkbutton(master, text=skills_list[3], variable=var4, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='white',selectcolor="black", command=lambda: toggle_var(var4))
        checkbutton4.grid(row=6, column = 2, sticky=W)
        
    if len(skills_list) >= 5:
        checkbutton5 = Checkbutton(master, text=skills_list[4], variable=var5, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='white',selectcolor="black", command=lambda: toggle_var(var5))
        checkbutton5.grid(row=7, column = 2,sticky=W)
        
    if len(skills_list) >= 6:
        checkbutton6 = Checkbutton(master, text=skills_list[5], variable=var6, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='white',selectcolor="black", command=lambda: toggle_var(var6))
        checkbutton6.grid(row=8, column = 2, sticky=W)
        
    if len(skills_list) >= 7:
        checkbutton7 = Checkbutton(master, text=skills_list[6], variable=var7, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='white',selectcolor="black", command=lambda: toggle_var(var7))
        checkbutton7.grid(row=3, column = 3,sticky=W)
        
    if len(skills_list) >= 8:
        checkbutton8 = Checkbutton(master, text=skills_list[7], variable=var8, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='white',selectcolor="black", command=lambda: toggle_var(var8))
        checkbutton8.grid(row=4, column = 3, sticky=W)
        
    if len(skills_list) >= 9:
        checkbutton9 = Checkbutton(master, text=skills_list[8], variable=var9, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='white',selectcolor="black", command=lambda: toggle_var(var9))
        checkbutton9.grid(row=5, column = 3,sticky=W)
        
    if len(skills_list) >= 10:
        checkbutton10 = Checkbutton(master, text=skills_list[9], variable=var10, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='white',selectcolor="black", command=lambda: toggle_var(var10))
        checkbutton10.grid(row=6, column = 3, sticky=W)
        
    if len(skills_list) >= 11:
        checkbutton11 = Checkbutton(master, text=skills_list[10], variable=var11, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='white',selectcolor="black", command=lambda: toggle_var(var11))
        checkbutton11.grid(row=7, column = 3,sticky=W)
        
    if len(skills_list) >= 12:
        checkbutton12 = Checkbutton(master, text=skills_list[11], variable=var12, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='white',selectcolor="black", command=lambda: toggle_var(var12))
        checkbutton12.grid(row=8, column = 3, sticky=W)
        
    if len(skills_list) >= 13:
        checkbutton13 = Checkbutton(master, text=skills_list[12], variable=var13, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='white',selectcolor="black", command=lambda: toggle_var(var13))
        checkbutton13.grid(row=3, column = 4,sticky=W)
        
    if len(skills_list) >= 14:
        checkbutton14 = Checkbutton(master, text=skills_list[13], variable=var14, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='white',selectcolor="black", command=lambda: toggle_var(var14))
        checkbutton14.grid(row=4, column = 4, sticky=W)
        
    if len(skills_list) >= 15:
        checkbutton15 = Checkbutton(master, text=skills_list[14], variable=var15, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='white',selectcolor="black", command=lambda: toggle_var(var15))
        checkbutton15.grid(row=5, column = 4,sticky=W)
        
    if len(skills_list) >= 16:
        checkbutton16 = Checkbutton(master, text=skills_list[15], variable=var16, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='white',selectcolor="black", command=lambda: toggle_var(var16))
        checkbutton16.grid(row=6, column = 4, sticky=W)
        
    if len(skills_list) >= 17:
        checkbutton17 = Checkbutton(master, text=skills_list[16], variable=var17, bg='#000011', fg = '#FFFFFF', activebackground='black', activeforeground='white',selectcolor="black", command=lambda: toggle_var(var17))
        checkbutton17.grid(row=7, column = 4, sticky=W)
...
def var_states():
    ...
    if len(questions) > questioncounter:
        ...
        if len(q) > 2000:
            ...
            label = Label(master, text=q, wraplength = wrapLen, font=("ariel",12), bg='#000011', fg = '#FFFFFF')
        if len(q) > 200:
            repr(q)
            q = q.strip()
            #print("\nafter strip command lol: ",q)
