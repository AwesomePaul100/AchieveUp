...
def main(question, name, result_list):
    #time.sleep(1)
    ...
    try:
        response = requests.get('http://'+server_ip+':8000/square?number=In_a_STEM_course,_with_'+str(len(result_list))+'_skills_listed_as:_'+str(result_list)+'_in_a_'+name+'_college_course_at_the_university_of_central_florida._With_the_following_question:_"'+question+'"._Please_select_between_1_and_5_skills_you_would_use_to_classify_the_question_skillsets.Only_select_the_ones_you_are_super_confident_match_the_question_with,_and_PLEASE_ONLY_RESPOND_WITh_the_SKILLS_using_commas_to_seperate_them_NO_EXPLANATION_before_or_after_NECESSARY_thank_you.')
    ...
    if str(response) == "<Response [200]>":
        print("got solutions: ", type(response.json()['result']))
...
#response = requests.get('http://192.168.168.103:8000/square?number=In_a_STEM_course,_with_'+str(skills_length)+'_skill_descriptions_listed_here:_'+updated_descriptions+',_and_the_following_acronyms:_'+updated_skills+'_associated_with_the_skillsets._With_the_following_question:_"'+question+'",_please_select_up_to_5_skills_you_would_use_to_classify_the_question_skillsets._You_do_not_need_to_select_5_skills,_just_the_ones_you_are_super_confident_with,_and_PLEASE_ONLY_RESPOND_WITh_the_ACRONYMS_using_commas_to_seperate_them_NO_EXPLANATION_before_or_after_NECESSARY_thank_you.')
